...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.8\textwidth]{figures/introduzione/img1.png}    
        \vspace{-5pt}     
    \end{figure}
    \begin{figure}[H]
        \centering
        \vspace{-8pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.8\textwidth]{figures/introduzione/img2.png}    
        \vspace{-5pt}     
    \end{figure}
...
Result: [1, 2, 3]
    ...
    \begin{figure}[H]
        ...
        \centering
        \vspace{-8pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.8\textwidth]{figures/introduzione/img3.png}    
        \vspace{-5pt}     
    \end{figure}
    \noindent
...
Result: ["banane", "pere"]
    ...
    \begin{figure}[H]
        \centering
        \vspace{-8pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.78\textwidth]{figures/introduzione/img4.png}    
        \vspace{-5pt}     
    \end{figure}
...
int main() {
    ...
    \raisebox{21pt}{  
        \begin{minipage}[t]{0.427\textwidth}
            \begin{figure}[H]
                \includegraphics[width=0.65\linewidth]{figures/introduzione/img7.png}          
            \end{figure}
...
#include <iostream>
    ...
    \raisebox{20pt}{  
        \begin{minipage}[t]{0.468\textwidth}
            \begin{figure}[H]
                \includegraphics[width=\linewidth]{figures/introduzione/img8.png}          
            \end{figure}
        \end{minipage}   
    }
...
int main() {
    ...
    *(ptr+3) = 3.5; // x[3] = 3.5
    ...
    \raisebox{19pt}{  
        \begin{minipage}[t]{0.468\textwidth}
            \begin{figure}[H]
                \includegraphics[width=\linewidth]{figures/introduzione/img9.png}          
            \end{figure}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.85\textwidth]{figures/iterazione_induzione_ricorsione/img1.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
  ...
  Ogni asserto dipende dal precedente in modo uniforme, e grazie alla dimostrazione del \textbf{passo induttivo} si garantisce la verità di tutti i passi successivi.
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.8\textwidth]{figures/iterazione_induzione_ricorsione/img2.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
...
x = f(x);   // f potrebbe non diminuire x!
    ...
    \begin{minipage}[t]{0.357\textwidth}  
        \includegraphics[width=\linewidth]{figures/iterazione_induzione_ricorsione/img6.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{127pt}{  
    ...
    \begin{minipage}[t]{0.275\textwidth}  
        \includegraphics[width=\linewidth]{figures/iterazione_induzione_ricorsione/img7.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{230pt}{  
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.7\textwidth]{figures/iterazione_induzione_ricorsione/img5.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
    ...
    \begin{figure}[ht]
        ...
        \subfloat[]{%
            \includegraphics[width=0.4\linewidth]{figures/iterazione_induzione_ricorsione/img3.png}
        } 
        \hspace{1cm}
        \subfloat[]{%
            \includegraphics[width=0.3\linewidth]{figures/iterazione_induzione_ricorsione/img4.png}
        }
    ...
    \begin{minipage}[t]{0.660\textwidth}  
        \includegraphics[width=\linewidth]{figures/introduzione/img10.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{210pt}{  
...
struct slist *root = NULL; 
    ...
    \raisebox{19pt}{  
        \begin{minipage}[t]{0.608\textwidth}
            \begin{figure}[H]
                \includegraphics[width=\linewidth]{figures/introduzione/img11.png}          
            \end{figure}
...
slist *insert(slist *p, int elem) {
    ...
    \begin{figure}[H]
        \centering
        \vspace{-5pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.8\textwidth]{figures/introduzione/img12.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
    \begin{itemize}[leftmargin=1em]
...
slist *insert2(slist *p, slist *q, int elem) {
    ...
    \begin{figure}[H]
        \centering
        \vspace{-5pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.9\textwidth]{figures/introduzione/img13.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
    \begin{itemize}[leftmargin=1em]
...
slist *delete(slist *p, slist *q) {
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.75\textwidth]{figures/introduzione/img14.png}        
        \vspace{-15pt}  % Riduce lo spazio sopra
    \end{figure}
    \begin{itemize}[leftmargin=1em]
...
return 0;
    ...
    \begin{minipage}[t]{0.603\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img1.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{185pt}{  
    ...
    \begin{figure}[H]
        ...
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=\textwidth]{figures/alberi/img2.png}
    ...
    \noindent
    \begin{minipage}[t]{0.603\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img3.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{127pt}{  
        \begin{minipage}[t]{0.373\textwidth}
    ...
    \begin{minipage}[t]{0.600\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img4.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{134pt}{  
...
int main(int argc, char *argv[]) {
    ...
    \begin{minipage}[t]{0.327\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img5.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{165pt}{  
    ...
    \begin{figure}[h]
        ...
        \subfloat[albero attraversato in preorder]{%
            \includegraphics[width=0.42\textwidth]{figures/alberi/img6.png}%
        }
        \hspace{2cm}
        \subfloat[Pseudocodice visita in preorder]{%
            \includegraphics[width=0.35\textwidth]{figures/alberi/img7.png}%
        }
    ...
    \begin{figure}[h]
        ...
        \subfloat[albero attraversato in postorder]{%
            \includegraphics[width=0.43\textwidth]{figures/alberi/img8.png}%
        }
        \hspace{2cm}
        \subfloat[Pseudocodice visita in postorder]{%
            \includegraphics[width=0.35\textwidth]{figures/alberi/img9.png}%
        } 
        \vspace{-10pt}  % Riduce lo spazio sotto
    \end{figure}
    \noindent
    ...
    \begin{figure}[h]
        ...
        \subfloat[albero attraversato inorder]{%
            \includegraphics[width=0.44\textwidth]{figures/alberi/img10.png}%
        }
        \hspace{2cm}
        \subfloat[Pseudocodice visita inorder]{%
            \includegraphics[width=0.35\textwidth]{figures/alberi/img11.png}%
        } 
        \vspace{-10pt}  % Riduce lo spazio sotto
    \end{figure}
    \noindent
...
int main(int argc, char *argv[]) {
    ...
    \begin{minipage}[t]{0.700\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img12.png}
    ...
    \noindent
    \begin{minipage}[t]{0.315\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img13.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{125pt}{  
...
bstree *search(bstree *p, int x) {
    ...
    \begin{itemize}[leftmargin=1em]
        ...
        \begin{minipage}[t]{0.263\textwidth}  
            ...
            \vspace{-19pt}
            \includegraphics[width=\linewidth]{figures/alberi/img14.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{-15pt}{  
...
bstree *insert(bstree *p, int x){
    ...
    \begin{itemize}[leftmargin=1em]
        ...
        \begin{minipage}[t]{0.263\textwidth}  
            ...
            \vspace{-19pt}
            \includegraphics[width=\linewidth]{figures/alberi/img15.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{0pt}{  
            \begin{minipage}[t]{0.689\textwidth}
...
int main(int argc, char *argv[]) {
    ...
    \begin{minipage}[t]{0.300\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img16.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{215pt}{  
...
int main(int argc, char *argv[]) {
    ...
    \begin{minipage}[t]{0.300\textwidth}  
        ...
        \vspace{-20pt}
        \includegraphics[width=\linewidth]{figures/alberi/img17.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{0pt}{  
        \begin{minipage}[t]{0.677\textwidth}
...
int main(int argc, char *argv[]) {
    ...
    \begin{figure}[h]
        ...
        \subfloat[\textit{Caso 1 - nessun figlio}]{%
            \includegraphics[width=0.46\textwidth]{figures/alberi/img18.png}%
        }
        \hspace{1cm}
        \subfloat[\textit{Caso 2 - un solo figlio}]{%
            \includegraphics[width=0.465\textwidth]{figures/alberi/img19.png}%
        } 
        \vspace{-10pt}  % Riduce lo spazio sotto
    \end{figure}
    ...
    \begin{itemize}[leftmargin=1em]
        ...
        \begin{minipage}[t]{0.527\textwidth}  
            ...
            \vspace{-20pt}
            \includegraphics[width=\linewidth]{figures/alberi/img20.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{0pt}{  
...
int main(int argc, char *argv[]) {
    ...
    \begin{minipage}[t]{0.195\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img21.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{127pt}{  
    ...
    \begin{minipage}[t]{0.257\textwidth}  
        \includegraphics[width=\linewidth]{figures/alberi/img22.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{79pt}{  
    ...
    \begin{itemize}[leftmargin=1em]
        ...
        \begin{minipage}[t]{0.550\textwidth} 
            \vspace{2pt}
            \includegraphics[width=\linewidth]{figures/alberi/img23.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{-8pt}{  
        ...
        \begin{minipage}[t]{0.550\textwidth} 
            \vspace{2pt}
            \includegraphics[width=\linewidth]{figures/alberi/img24.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{-10pt}{  
            \begin{minipage}[t]{0.403\textwidth}
        ...
        \begin{figure}[H]
            \centering
            \vspace{-10pt}  % Riduce lo spazio sopra
            \includegraphics[width=0.9\textwidth]{figures/alberi/img25.png}
        ...
        \begin{figure}[H]
            \centering
            \vspace{-10pt}  % Riduce lo spazio sopra
            \includegraphics[width=0.9\textwidth]{figures/alberi/img26.png}
            \vspace{-16pt}  % Riduce lo spazio sopra
        \end{figure}
...
bstree * rotateright(bstree *x) {
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.8\textwidth]{figures/alberi/img27.png}
        \vspace{-16pt}  % Riduce lo spazio sopra
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=\textwidth]{figures/complessita_algoritmi/img1.png}
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=\textwidth]{figures/complessita_algoritmi/img2.png}
        \vspace{-30pt}  % Riduce lo spazio sopra 
    \end{figure}
    \noindent
    ...
    \begin{itemize}[leftmargin=1em]
        ...
        \begin{minipage}[t]{0.550\textwidth} 
            \vspace{2pt}
            \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img3.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{-10pt}{  
            \begin{minipage}[t]{0.403\textwidth}
        ...
        \begin{minipage}[t]{0.550\textwidth} 
            \vspace{2pt}
            \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img4.png}
        \end{minipage}%
        \hspace{5pt} % Spazio tra immagine e testo
        \raisebox{-10pt}{  
            \begin{minipage}[t]{0.403\textwidth}
    ...
    \begin{figure}[h]
        ...
        \vspace{-5pt}  % Riduce lo spazio sopra
        \subfloat[]{%
            \includegraphics[width=0.58\linewidth]{figures/complessita_algoritmi/img5.png}
        } 
        \hspace{0.1cm}
        \subfloat[]{%
            \includegraphics[width=0.38\linewidth]{figures/complessita_algoritmi/img9.png}
        }
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[h]
        ...
        \subfloat[Notazione $O$ grande]{%
            \includegraphics[width=0.31\linewidth]{figures/complessita_algoritmi/img6.png}
        } 
        \hspace{0.1cm}
        \subfloat[Notazione $\Omega$ grande]{%
            \includegraphics[width=0.31\linewidth]{figures/complessita_algoritmi/img7.png}
        }
        \hspace{0.1cm}
        \subfloat[Notazione $\Theta$ grande]{%
            \includegraphics[width=0.31\linewidth]{figures/complessita_algoritmi/img8.png}
        }
        \vspace{-15pt}  % Riduce lo spazio sotto
    \end{figure}
    \FloatBarrier
    ...
    \begin{minipage}[t]{0.550\textwidth} 
        \vspace{2pt}
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img10.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{-10pt}{  
        \begin{minipage}[t]{0.427\textwidth}
    ...
    \begin{figure}[h]
        ...
        \vspace{-5pt}  % Riduce lo spazio sopra
        \subfloat[]{%
            \includegraphics[width=0.495\linewidth]{figures/complessita_algoritmi/img11.png}
        } 
        \hspace{0.1cm}
        \subfloat[]{%
            \includegraphics[width=0.40\linewidth]{figures/complessita_algoritmi/img12.png}
        }
    \end{figure}
    \FloatBarrier
    ...
    \begin{minipage}[t]{0.540\textwidth} 
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img16.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{177pt}{  
    ...
    \begin{figure}[H]
        ...
        \vspace{-5pt}  % Riduce lo spazio sopra
        \subfloat[]{%
            \includegraphics[width=0.41\linewidth]{figures/complessita_algoritmi/img13.png}
        } 
        \hspace{1cm}
        \subfloat[]{%
            \includegraphics[width=0.41\linewidth]{figures/complessita_algoritmi/img14.png}
        }
        \hspace{1cm}
        \subfloat[]{%
            \includegraphics[width=0.41\linewidth]{figures/complessita_algoritmi/img15.png}
        }
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[H]
        ...
        \subfloat[Partizionamento dei dati]{%
            \includegraphics[width=0.47\linewidth]{figures/complessita_algoritmi/img17.png}
        } 
        \hspace{0.1cm}
        \subfloat[Fusione dei dati]{%
            \includegraphics[width=0.47\linewidth]{figures/complessita_algoritmi/img18.png}
        }
    \end{figure}
    \FloatBarrier
    ...
    \begin{minipage}[t]{0.500\textwidth} 
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img20.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{95pt}{  
    ...
    \begin{minipage}[t]{0.560\textwidth} 
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img23.png}
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img21.png}
        \includegraphics[width=\linewidth]{figures/complessita_algoritmi/img22.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{18pt}{  
    ...
    \begin{figure}[H]
        ...
        \label{fig:figure67}
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.9\textwidth]{figures/complessita_algoritmi/img19.png}
        \vspace{-5pt}  % Riduce lo spazio sopra 
    \end{figure}
    \noindent
    ...
    \noindent 
    \begin{minipage}[t]{0.560\textwidth} 
         \includegraphics[width=\textwidth]{figures/complessita_algoritmi/img24.png}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{66pt}{  
        \begin{minipage}[t]{0.417\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.9\textwidth]{figures/complessita_algoritmi/img25.png}
        \vspace{-15pt}  % Riduce lo spazio sopra 
    \end{figure}
    \noindent
...
\begin{figure}[H]
    \centering
    % NOTA: Ho commentato l'immagine per permettere la compilazione se il file non esiste.
    % De-commenta la riga sotto se hai il file nella cartella corretta.
    % \includegraphics[width=0.65\linewidth]{figures/strutture_dati_astratti/img1.png}
    \textbf{[Qui andrebbe l'immagine img1.png]}
...
\end{lstlisting}
    ...
    \begin{minipage}[t]{0.6\textwidth}  
        \includegraphics[width=\linewidth]{figures/divide-et-impera/VettoreEsempio.pdf}
    \end{minipage}
    \hspace{5pt}\\
    \noindent
    ...
    \begin{minipage}[t]{0.7\textwidth}  
        \includegraphics[width=\linewidth]{figures/divide-et-impera/QS1.pdf}
    \end{minipage}
    \hspace{5pt}\\
    \noindent
    ...
    \begin{minipage}[t]{0.60\textwidth}  
        \includegraphics[width=\linewidth]{figures/divide-et-impera/Pivot.pdf}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \raisebox{135pt}{  
    ...
    \begin{minipage}[t]{0.50\textwidth}  
        \includegraphics[width=\linewidth]{figures/divide-et-impera/pivot1.pdf}
    \end{minipage}%
    \hspace{5pt} % Spazio tra immagine e testo
    \begin{minipage}[t]{0.50\textwidth}
        \includegraphics[width=\linewidth]{figures/divide-et-impera/pivot2.pdf}
    \end{minipage} 
    ...
    \hspace{5pt}
    \begin{minipage}[t]{0.5\textwidth}  
        \includegraphics[width=\linewidth]{figures/divide-et-impera/SvolgimentoRicorsione.pdf}
    \end{minipage}
    \hspace{5pt}
    ...
    \begin{figure}[H]
        \centering
        \vspace{-10pt}  % Riduce lo spazio sopra
        \includegraphics[width=0.95\textwidth]{figures/hashing/img1.png}
        \vspace{-5pt}  % Riduce lo spazio sopra 
    \end{figure}
    \noindent
