...
bstree * rotateright(bstree *x) {
    ...
    \begin{itemize}[leftmargin=1em]
        \item \textbf{\textit{Livello 0}}: abbiamo lespressione originale;
    ...
    \end{figure}
    \noindent
    Per capire quale sia la complessità di \texttt{mergeSort()} dobbiamo trovare separatamente la complessità di \texttt{merge()}.\\
    ...
    \end{tcolorbox}
    \noindent
    L'intero algoritmo è un programma che richiama ricorsivamente se stesso e usa la funzione \texttt{merge()} per unire i risultati
