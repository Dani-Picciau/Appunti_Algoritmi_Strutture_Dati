...
\begin{itemize}[leftmargin=1em]
    ...
    \item \textbf{Indirizzamento aperto}: come è stato visto, in questo caso ogni cella può contenere al massimo 1 elemento, quindi $n$ (elementi) non potrà mai superare $m$ celle, di conseguenza $0<\alpha<1$.
\end{itemize}
