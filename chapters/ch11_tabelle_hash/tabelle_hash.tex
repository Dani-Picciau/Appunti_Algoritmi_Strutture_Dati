...
\begin{itemize}[leftmargin=1em]
    \item \textbf{Inserimento}: domanda per gemini: (cosa succede se sequenza di ispezione finisce e non ci sono spazi vuoti?)
    \item \textbf{Ricerca}: significa che ho trovato la chiave che stavo cercando poiché la sequenza di ispezione non va oltre
\end{itemize}
\end{document}