...
% Monica package
\usepackage{adjustbox} % per poter allineare in orizzontale le immagini 
\usepackage{soul} % per l'evidenziatore
\sethlcolor{yellow!55} % per definire il colore dell'evidenziatore
\definecolor{commentcolor2}{RGB}{175, 50, 53} % Arancione dei commenti su più righe di Python
